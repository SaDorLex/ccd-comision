...
<html>
    ...
    <body class="overflow-x-hidden">
        <div class="bg-[rgba(0,0,0,0.25)] h-full w-full z-10 fixed flex">
            <div class="w-1/2 h-[10vw] bg-white border-azul-pedro-400 border-[0.2vw] rounded-[0.5vw] m-auto flex flex-col relative">
                ...
                <div class=" w-fit mx-auto flex gap-[1vw]">
                    ...
                    <input class="border-[0.15vw] border-azul-pedro-500 px-[0.4vw] py-[0.4vw] rounded-[0.5vw] w-[20vw] text-[1vw]" type="text">
                </div>
                <div>
                    <button></button>
                </div>
            ...
            <div class="w-[79vw]">
                ...
                <div class="grid grid-cols-3 w-[95%] mx-auto">
                    ...
                    <div class="grid grid-cols-2">
                        ...
                        <input id="fecha_inicio" class="h-fit my-auto px-[0.5vw] py-[0.5vw] text-[1.1vw] border-azul-univ border-[0.2vw] rounded-[1vw]" type="date" min="">
                    </div>
                    <div class="grid grid-cols-2">
                        <label class="text-center my-auto text-[1.5vw] text-azul-univ font-semibold">Fecha de<br>Término</label>
                        <input id="fecha_termino" class="h-fit my-auto px-[0.5vw] py-[0.5vw] text-[1.1vw] border-azul-univ border-[0.2vw] rounded-[1vw]" type="date" disabled>
                    </div>
                </div>
                <div class="w-full mx-auto my-[2vw] grid gap-[1vw] text-[1.5vw] text-center relative">
                    ...
                    <div class="w-fit mx-auto grid grid-cols-2">
                        <div class="grid grid-cols-2">
                            ...
                            <input id="horaInicio" class="h-fit my-auto px-[0.5vw] py-[0.5vw] text-[1.1vw] border-azul-univ border-[0.2vw] rounded-[1vw] w-[10vw]" type="time">
                        </div>
                        <div class="grid grid-cols-2">
                            <label class="text-center my-auto text-[1.5vw] text-azul-univ font-semibold">Hora de<br>Término</label>
                            <input id="horaFin" class="h-fit my-auto px-[0.5vw] py-[0.5vw] text-[1.1vw] border-azul-univ border-[0.2vw] rounded-[1vw] w-[10vw]" type="time">
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-2 w-[70%] mx-auto">
                    ...
                    <div class="grid">
                        ...
                        <textarea id="comentarios" class="border-azul-univ border-[0.2vw] rounded-[1vw] resize-none p-[1vw] w-full my-[1vw] text-[1.2vw]"></textarea>
                    </div>
                </div>
                ...
                <div id="lstCargaArchivos">
                    <x-rowCargaDeArchivos/>  
                </div>
                <div class="w-full flex">
                    <button id="btnAgregarArchivo" class="bg-lime-300 text-[0.8vw] rounded-[0.5vw] px-[0.5vw] py-[0.25vw] ml-auto mr-[1vw] transition-all duration-300 ease-linear hover:bg-lime-600">Añadir Requisito de Archivo</button>
                </div>
                <div class="w-fit my-[1vw] mx-auto text-[1.8vw] font-bold text-azul-univ">
                ...
                <div class="w-[90%] mx-auto my-[2vw] flex pb-[3vw]">
                    <button id="btnCrearConvocatoria" class="ml-auto bg-lime-500 text-white font-bold px-[0.4vw] py-[0.2vw] text-[1.3vw] rounded-[0.5vw] duration-300 transition-all ease-linear hover:bg-lime-600">
                        Crear Convocatoria
                    </button>
                </div>
            </div>
