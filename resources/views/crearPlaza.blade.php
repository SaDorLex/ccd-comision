...
<head>
    <title>Crear Plaza - Comision</title>
...
<body class="overflow-x-hidden">
    ...
    <div class="flex h-[80vh]">
        ...
        <div class="w-[79vw]">
            ...
            <div class="w-[90%] grid grid-cols-3 mx-auto my-[1vw]">
                <div class="grid grid-cols-2">
                    <label class="text-center my-auto text-[1.5vw] text-azul-univ font-semibold">Facultad</label>
                    <select id="lstFacultad"
            ...
            <div class="w-[90%] mx-auto grid grid-cols-4 my-[2vw] gap-[1vw]">
                ...
                <div class="grid grid-cols-2">
                    ...
                    <input id="hlectivas" class="w-[50%] h-fit text-[1.3vw] my-auto mx-auto border-[0.15vw] border-black rounded-[1vw] p-[0.5vw]" type="number" disabled value="0">
                </div>
                <div class="grid grid-cols-2">
                    <label class="text-center my-auto text-[1.3vw]">Horas No Lectivas: </label>
                    <input id="hnolectivas" class="w-[50%] h-fit text-[1.3vw] my-auto mx-auto border-[0.15vw] border-black rounded-[1vw] p-[0.5vw]" type="number" disabled value="0">
                </div>
                <div class="grid grid-cols-2">
                    <label class="text-center my-auto text-[1.3vw]">Horas Totales: </label>
                    <input id="htotal" class="w-[50%] h-fit text-[1.3vw] my-auto mx-auto border-[0.15vw] border-black rounded-[1vw] p-[0.5vw]" type="number" disabled value="0">
                </div>
            </div>
            ...
            <div class="mx-auto w-[90%] my-[1vw]">
                ...
                <textarea id="requisitos" class="border-black border-2 rounded-[1vw] resize-none p-[1vw] w-full h-[10vw] my-[1vw] text-[1.2vw]"></textarea>
            </div>
            <div class="w-[90%] mx-auto my-[2vw] flex pb-[3vw]">
                <button id="btnCrearPlaza" class="ml-auto bg-lime-500 text-white font-bold px-[0.4vw] py-[0.2vw] text-[1.3vw] rounded-[0.5vw] duration-300 transition-all ease-linear hover:bg-lime-600">
                    Crear Plaza
                </button>
            </div>
        </div>
    ...
    <script>
        ...
        var urlFacultad = '{{ route('listarFacultades') }}';
