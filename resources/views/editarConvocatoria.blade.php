    ...
    <div class="flex h-[80vh]">
        ...
        <div class="w-[79vw]">
                ...
                <div class="grid grid-cols-3 w-[95%] mx-auto">
                    ...
                    <div class="grid grid-cols-2">
                        ...
                        <input id="fecha_inicio"
                            class="h-fit my-auto px-[0.5vw] py-[0.5vw] text-[1.1vw] border-azul-univ border-[0.2vw] rounded-[1vw]"
                            type="date" min="" value="{{ $convocatoria->fecha_inicio }}">
                    </div>
                    <div class="grid grid-cols-2">
                        <label class="text-center my-auto text-[1.5vw] text-azul-univ font-semibold">Fecha
                            de<br>Término</label>
                        <input id="fecha_termino"
                            class="h-fit my-auto px-[0.5vw] py-[0.5vw] text-[1.1vw] border-azul-univ border-[0.2vw] rounded-[1vw]"
                            type="date" value="{{ $convocatoria->fecha_termino }}">
                    </div>
                </div>
                    ...
                    <div class="w-fit mx-auto grid grid-cols-2">
                        <div class="grid grid-cols-2">
                            ...
                            <input id="horaInicio"
                                ...
                                type="time" value="{{ $convocatoria->horario->hora_inicio }}">
                        </div>
                        <div class="grid grid-cols-2">
                            <label class="text-center my-auto text-[1.5vw] text-azul-univ font-semibold">Hora
                                de<br>Término</label>
                            <input id="horaFin"
                                class="h-fit my-auto px-[0.5vw] py-[0.5vw] text-[1.1vw] border-azul-univ border-[0.2vw] rounded-[1vw] w-[10vw]"
                                type="time" value="{{ $convocatoria->horario->hora_termino }}">
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-2 w-[70%] mx-auto">
                    ...
                    <div class="grid">
                        ...
                        <textarea id="comentarios"
                            class="border-azul-univ border-[0.2vw] rounded-[1vw] resize-none p-[1vw] w-full my-[1vw] text-[1.2vw]">{{ $convocatoria->comentarios }}</textarea>
                    </div>
                </div>
            </div>
            <div id="formParteDos" class="hidden">
                ...
                <div
                    class="bg-azul-pedro-400 rounded-[0.5vw] px-[1vw] py-[0.5vw] grid [grid-template-columns:0.1fr_2fr_1fr_0.5fr] w-[80%] mx-auto">
            ...
            <div id="formParteTres" class="hidden">
                ...
                <div class="w-[90%] mx-auto my-[2vw] flex pb-[3vw]">
                    <button id="btnEditarConvocatoria"
                        class="ml-auto bg-amber-500 text-white font-bold px-[0.4vw] py-[0.2vw] text-[1.3vw] rounded-[0.5vw] duration-300 transition-all ease-linear hover:bg-amber-600">
                        Guardar Cambios
                    </button>
                </div>
            </div>
            <div class="flex w-[95%] mx-auto justify-between relative my-[1vw]">
                <button onclick="prevForm()" id="btnRegresar"
                    class="left-0 hidden absolute bg-azul-pedro-700 text-white py-[0.3vw] px-[0.6vw] text-[1.2vw] rounded-[0.5vw] ease-linear transition-all duration-300 hover:bg-azul-pedro-500">Regresar</button>
                <button onclick="nextForm()" id="btnSiguiente"
                    class="right-0 absolute bg-azul-pedro-700 text-white py-[0.3vw] px-[0.6vw] text-[1.2vw] rounded-[0.5vw] ease-linear transition-all duration-300 hover:bg-azul-pedro-500">Siguiente</button>
            </div>
        </div>
    </div>
    <script>
